...
class GameMasterAgent(Agent):
    def __init__(self):
        instructions = """
        You are 'Ramesh', the friendly shopkeeper and voice assistant for Everyday Elegance shop.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info(" STARTING VOICE E-COMMERCE AGENT (Everyday Elegance Shop) — Ramesh")
